...
def get_labels(path):
    ...
    return ['O','B-ShareRepurchase', 'I-ShareRepurchase', 'B-Profit', 'I-Profit', 'B-QuarterlyResults', 'I-QuarterlyResults',
    'B-Dividend', 'I-Dividend', 'B-BuyRating', 'I-BuyRating', 'B-SalesVolume', 'I-SalesVolume', 'B-Turnover', 'I-Turnover',
    'B-MergerAcquisition', 'I-MergerAcquisition', 'B-TargetPrice', 'I-TargetPrice', 'B-Debt', 'I-Debt']
...
def get_label_seed_list(path):
    ...
    return ['ShareRepurchase', 'Profit', 'QuarterlyResults', 'Dividend', 'BuyRating', 'SalesVolume', 'Turnover',
            'MergerAcquisition','TargetPrice','Debt']
